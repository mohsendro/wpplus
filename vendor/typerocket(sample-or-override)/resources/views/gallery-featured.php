...
<section id="gallery" class="container gallery">
    <div class="row">
        <div class="col-12 count-post">
            تعداد نتایج: <strong><?php echo $count; ?></strong> | دسته بندی: <strong>گالری‌های منتخب</strong>
        </div>
        <?php if( $posts ): ?>
...
<?php
    ...
    insertPagination(home_url('gallery/gallery-featured' . $category->slug . '/page'), $current_page, $total_page, true);
?>
