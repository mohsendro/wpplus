...
class ElementorDatepickerLocalization  {
	...
	function script_register() {
		wp_register_script( 'flatpickr_localize', plugin_dir_url( __DIR__ ) . "localization/{$this->locale}.js", [ 'flatpickr' ] );
	}
...
$wpplus_persian_elementor_localization = new ElementorDatepickerLocalization ();